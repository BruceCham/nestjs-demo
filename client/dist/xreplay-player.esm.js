...
function revertStrByPatches(str, changes) {
  changes.forEach((change) => {
    ...
    switch (type) {
      case 'add':
        str =
          str.substring(0, change.index) + value + str.substring(change.index);
        break;
      case 'rm':
        str =
...
function convertVNode(vNode, parent) {
  ...
  if (vNode.type === Node.TEXT_NODE) {
    if (parent && parent.tag === 'style') {
      const baseUrl =
        parent === null || parent === void 0 ? void 0 : parent.attrs['css-url'];
...
let ToolboxComponent = class ToolboxComponent {
  constructor(options, c) {
    this.options = options;
    this.c = c;
    this.target = this.target || c.target;
...
class PlayerModule {
  ...
  getRecords(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const records =
        recordsData || (receiver && (yield this.dataReceiver(receiver)));
      if (!records) {
